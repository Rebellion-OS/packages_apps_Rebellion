/*
 * Copyright (C) 2019 The rebellion X Project
 *
...
public class StatusBarSettings extends SettingsPreferenceFragment implements
    ...
    private SwitchPreference mShowRebellionLogo;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mShowRebellionLogo = (SwitchPreference) findPreference(KEY_STATUS_BAR_LOGO);
        mShowRebellionLogo.setChecked((Settings.System.getInt(getContentResolver(),
             Settings.System.STATUS_BAR_LOGO, 0) == 1));
        mShowRebellionLogo.setOnPreferenceChangeListener(this);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if  (preference == mShowRebellionLogo) {
